    ...
    <View style={{ marginHorizontal: 10, backgroundColor: "00000099" }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: '#000', borderRadius: 20, paddingHorizontal: 10, marginTop: 18, height: 45 }}>
          ...
          <View style={{}}>
            ...
            <Text style={[styles.downlodText, { fontSize: 17, fontWeight: "700" }]}>yuuuuuu </Text>
      ...
      <View style={{ backgroundColor: "#000",marginHorizontal:12,borderRadius:18,marginTop:10,flex:1}}>
      <View>
        <View style={{ borderWidth: 3, borderBottomColor: "red", width: 130, alignSelf: "center" }}></View>
        <View>
          <View style={[styles.HartView2, { justifyContent: "space-around", }]}>
            <View style={[styles.HartView, { width: "16%", backgroundColor: "gray", alignItems: "center" }]}>
              <Text style={styles.text}>5</Text>
            </View>
            <View style={[styles.HartView, { marginLeft: 10, width: "16%", backgroundColor: "gray" }]}>
          ...
          <View style={[styles.HartView2, { justifyContent: "space-between", }]}>
            ...
            <View style={[styles.HartView, { marginLeft: 10, width:"25%", backgroundColor: "gray" }]}>
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: "#037171", padding: 18, width: "60%", borderRadius: 40, alignSelf: "center", marginTop: 20, justifyContent: "flex-end",borderWidth:3,borderColor:"gray"
  },
  downlodText: {
